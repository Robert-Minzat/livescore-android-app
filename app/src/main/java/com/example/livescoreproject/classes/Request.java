...
public class Request extends AsyncTask<URL, Void, List<Match>> {
        ...
        try {
            ...
            for (URL url : urls) {
                ...
                for (int i = 0; i < matchesArray.length(); i++) {
                    ...
                    awayTeamScore = matchObj.getJSONObject("score").getJSONObject("fullTime").isNull("homeTeam")
                            ? 0 : matchObj.getJSONObject("score").getJSONObject("fullTime").getInt("homeTeam");
                    ...
                    matchToAdd = new Match(
                            ...
                            homeTeamScore,
                            awayTeamScore,
                            matchObj.getJSONObject("score").getString("winner").equals("HOME_TEAM") ? 1 : 2,
